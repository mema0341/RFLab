...
# Part 3: Construct and print the A or G-Matrix using the ECEF coordinates of the GPS satellites and the observer as
# discussed in lecture or in your book. 
for zz in range(5):
    ...
    my_keys = [1, 10, 11, 12, 20, 21, 22, 25, 31, 32]
    for alm_key in my_keys:
        ...
        print("Expected Range: {} m".format(satExpectedRange[0]))
        print("Iono-Corrected : {} m".format(PRIF[0]))
        print("Clock Correction: {} m".format(clock_corr[0]))
        print("Relativity Correction: {} m".format(rel_corr[0]))
        print("Azimuth: {} deg   Elevation: {} deg".format(azs[0], els[0]))
        print("Tropo Correction: {} m".format(tropo_vals[0]))
        print("")
